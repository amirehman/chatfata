...
<div class="body-title">Name: {{$name}}</div>
<div class="body-title"><br />
<div class="body-title">Email: {{$email}}</div>
<div class="body-title"><br />
<div class="body-title">Phone: {{$phone}}<br />
<div class="body-title">&nbsp;</div>
<div class="body-title">Message:&nbsp;</div>
<div class="body-title" align="left">&nbsp;</div>
<div class="body-title" align="left">{!! $bodyMessage !!}</div>
</div>
</div>
</div>
<br />
